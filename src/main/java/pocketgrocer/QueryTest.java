...
public class QueryTest {// DB Connection
    ...
    //canned queries
    private static final String INSERT_USER = "INSERT INTO USERSTEST VALUES (?,?,?,?,?)";
    private PreparedStatement insertUser;


    private static final String DELETE_USER = "DELETE FROM USERSTEST WHERE userName = (?)";
    private PreparedStatement deleteUser;


    private static final String CHECK_USER = "SELECT COUNT(*) FROM USERSTEST WHERE userName = (?)";
    private PreparedStatement checkUser;

    private static final String GET_GROUPNAME = "SELECT groupName FROM USERSTEST WHERE userName = (?)";
    private PreparedStatement getGroupName;

    private static final String GET_GROUP_MEMBERS = "SELECT userName FROM USERSTEST WHERE groupName = (?)";
    private PreparedStatement getGroupMembers;


    private static final String CHECK_GROUP = "SELECT COUNT(*) FROM USERSTEST WHERE groupName = (?)";
    ...
    private static final String CHECK_ITEM = "SELECT COUNT(*) FROM INVENTORYTEST WHERE itemID = (?)";
    private PreparedStatement checkItem;

    //Update [dbo].[INVENTORY] set shared = 0 WHERE itemID = 3;
    private static final String CHANGE_SHARED = "UPDATE INVENTORYTEST SET shared = (?) WHERE itemID = (?)";
